...
SWIFT_CLASS("_TtC7SetGame14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified deal3CardsButton;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified scoreLabel;
- (IBAction)touchDeal3MoreCards:(UIButton * _Nonnull)sender;
- (IBAction)CardButtonPressed:(UIButton * _Nonnull)sender;
- (IBAction)touchNewGame:(UIButton * _Nonnull)sender;
- (void)viewDidLoad;
